...
def get_args():
    ...
    parser.add_argument(
        ...
        type=int,
        nargs=3,
        help="container size (width, length, height)",
    )
    parser.add_argument(
        "--item-size-range",
        default=[1, 1, 1, 2, 2, 2],
        type=int,
        nargs=6,
        help="item size range (min_w, min_l, min_h, max_w, max_l, max_h)",
    )
    ...
    args.bin_size = (
        args.container_size[0],
        args.container_size[1],
        args.container_size[2],
    )
