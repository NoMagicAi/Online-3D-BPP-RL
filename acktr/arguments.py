...
def get_args():
    ...
    parser.add_argument(
        "--mode",
        default="train",
        help="Test trained model or train new model, test | train",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        nargs=3,
        type=int,
        help="container size along x, y and z axis",
    )
    parser.add_argument(
        "--enable-rotation",
        action="store_true",
        default=False,
        help="Whether agent can rotate boxes",
    )
    parser.add_argument(
        "--load-model",
        action="store_true",
        default=False,
        help="Whether to use trained model",
    )
    parser.add_argument(
        "--load-name",
    ...
    parser.add_argument(
        "--data-name", default="cut_2.pt", help="The name of testing dataset"
    )
    parser.add_argument(
        "--item-size-range",
        default=(2, 2, 2, 5, 5, 5),
        nargs=6,
        type=tuple,
        help="the item size range, (min_width, min_length, min_height, max_width, max_length, max_height)",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="whether use tensorboard to tracing trainning process",
    )
    parser.add_argument(
        "--preview",
        default=1,
        type=int,
        help="the item number agent knows (ignored when training)",
    )
    parser.add_argument(
        "--item-seq",
        default="cut1",
        help="item sequence generators (ignored when testing), cut1|cut2|rs",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        default=2,
        type=float,
        help="invalid action possibility term coefficient",
    )
    parser.add_argument(
        "--hidden_size",
        default=256,
        type=int,
        help="hidden layer cell number (default: 256)",
    )
    parser.add_argument(
        "--learning_rate",
        default=1e-6,
        type=float,
        help="learning rate for a2c (default: 1e-6)",
    )
    parser.add_argument(
        "--eps",
        default=1e-5,
    ...
    parser.add_argument("--device", default=0, type=int, help="device id (default: 0)")
    parser.add_argument(
        "--save_interval",
        default=10,
        type=int,
    ...
    parser.add_argument(
        ...
        default=100,
        type=int,
        help="the number of sequences used for test (default 100)",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="whether agent can rotate box",
    )
    parser.add_argument(
        "--data_name",
        default="cut_2.pt",
        help=" the name of dataset, check data_dir for details",
    )
    parser.add_argument(
        "--load_name",
        default="default_cut_2.pt",
        help="default trained model for testing or continuing training",
    )
    parser.add_argument(
        "--load_dir",
        default="./pretrained_models/",
        help="directory to load agent logs (default: ./pretrained_models/)",
    )
    parser.add_argument(
        "--save_dir",
    ...
    args.channel = (
        4  # channels of CNN: 4 for hmap+next box, 5 for hmap nextbox+truemask
    )
